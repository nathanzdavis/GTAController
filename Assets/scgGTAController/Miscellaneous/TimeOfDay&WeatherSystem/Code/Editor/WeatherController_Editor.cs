...
public class WeatherController_Editor : Editor
{
    ...
    private void DrawNewGUI()
    {
        ...
        GUILayout.BeginHorizontal();
        GUILayout.Label("Cloud Low (Material): ");
        cl.matCloudsLow = EditorGUILayout.ObjectField("", cl.matCloudsLow, typeof(Material), true, GUILayout.MaxWidth(iMaxWidth)) as Material;
        GUILayout.EndHorizontal();

        GUILayout.BeginHorizontal();
        GUILayout.Label("Cloud High (Material): ");
        cl.matCloudsHigh = EditorGUILayout.ObjectField("", cl.matCloudsHigh, typeof(Material), true, GUILayout.MaxWidth(iMaxWidth)) as Material;
        GUILayout.EndHorizontal();

        GUILayout.BeginHorizontal();
        GUILayout.Label("Cloud Low Default Transparency (Material): ");
        cl.cloudDefaultTransparencyLow = EditorGUILayout.FloatField(cl.cloudDefaultTransparencyLow, GUILayout.MaxWidth(iMaxWidth));
        GUILayout.EndHorizontal();

        GUILayout.BeginHorizontal();
        GUILayout.Label("Cloud High Default Transparency (Material): ");
        cl.cloudDefaultTransparencyHigh = EditorGUILayout.FloatField(cl.cloudDefaultTransparencyHigh, GUILayout.MaxWidth(iMaxWidth));
        GUILayout.EndHorizontal();
